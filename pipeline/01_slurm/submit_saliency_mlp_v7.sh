#!/usr/bin/env bash
#SBATCH --job-name=saliency_mlp_v7
#SBATCH --output=logs/saliency_mlp_v7.%j.out
#SBATCH --error=logs/saliency_mlp_v7.%j.err
...
echo "Running saliency_mlp against V7 | Job ${SLURM_JOB_ID} | $(date)"
cd ${PROJECT_DIR}
