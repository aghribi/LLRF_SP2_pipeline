#!/usr/bin/env bash
#SBATCH --job-name=phaseA_shap_v7
#SBATCH --output=logs/phaseA_shap_v7.%j.out
#SBATCH --error=logs/phaseA_shap_v7.%j.err
...
SCRIPT="${PROJECT_DIR}/pipeline/00_scripts/prepare_07a_phaseA_shap.py"
