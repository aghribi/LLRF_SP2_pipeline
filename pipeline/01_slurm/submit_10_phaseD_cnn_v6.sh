...
# Usage: sbatch submit_10_phaseD_cnn_v6.sh

#SBATCH --job-name=phaseD_cnn_v6
#SBATCH --output=logs/phaseD_cnn_v6.%j.out
#SBATCH --error=logs/phaseD_cnn_v6.%j.err
...
cd "$PROJECT_ROOT"
"$PY_BIN" "$SCRIPT" --arch cnn --epochs 50 --batch-size 128 --device cpu
