#!/bin/bash
#SBATCH --job-name=step_07A_v6
#SBATCH --output=logs/step_07_phaseA_v6_%j.out
#SBATCH --error=logs/step_07_phaseA_v6_%j.err
...
python pipeline/00_scripts/phaseA_br_test.py \
    ...
    --output ${COOKED_DATA}/step_07_phaseA_v6_br
EXIT_CODE=$?
