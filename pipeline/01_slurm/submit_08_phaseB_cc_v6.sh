#!/usr/bin/env bash
# SLURM submit script for Phase B (Classifier Chains), against V6 dataset
# Usage: sbatch submit_08_phaseB_cc_v6.sh

#SBATCH --job-name=phaseB_cc_v6
#SBATCH --output=logs/phaseB_cc_v6.%j.out
#SBATCH --error=logs/phaseB_cc_v6.%j.err
