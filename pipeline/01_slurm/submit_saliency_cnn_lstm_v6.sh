#!/usr/bin/env bash
#SBATCH --job-name=saliency_cnn_lstm_v6
#SBATCH --output=logs/saliency_cnn_lstm_v6.%j.out
#SBATCH --error=logs/saliency_cnn_lstm_v6.%j.err
...
echo "Running saliency_cnn_lstm against V6 | Job ${SLURM_JOB_ID} | $(date)"
cd ${PROJECT_DIR}
