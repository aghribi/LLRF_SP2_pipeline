#!/usr/bin/env bash
#SBATCH --job-name=phaseC_shap_v6
#SBATCH --output=logs/phaseC_shap_v6.%j.out
#SBATCH --error=logs/phaseC_shap_v6.%j.err
...
SCRIPT="${PROJECT_DIR}/pipeline/00_scripts/extract_shap_phaseC_lp.py"
