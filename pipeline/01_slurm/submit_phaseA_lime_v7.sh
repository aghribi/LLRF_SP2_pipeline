#!/usr/bin/env bash
#SBATCH --job-name=phaseA_lime_v7
#SBATCH --output=logs/phaseA_lime_v7.%j.out
#SBATCH --error=logs/phaseA_lime_v7.%j.err
...
echo "Running phaseA_lime against V7 | Job ${SLURM_JOB_ID} | $(date)"
cd ${PROJECT_DIR}
