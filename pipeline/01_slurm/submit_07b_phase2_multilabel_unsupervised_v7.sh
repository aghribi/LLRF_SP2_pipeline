#!/bin/bash
#SBATCH --job-name=step_07b_v7
#SBATCH --output=logs/step_07b_v7_%j.out
#SBATCH --error=logs/step_07b_v7_%j.err
#SBATCH --time=2:00:00
...
echo "STEP 07b: Phase 2 - Multi-Label, Unsupervised (full window) | Job ${SLURM_JOB_ID} | $(date)"
...
${PYTHON_ENV} pipeline/00_scripts/prepare_07b_phase2_multilabel_unsupervised.py \
    --input ${COOKED_DATA} \
    --output ${COOKED_DATA}/step_07b_phase2_unsupervised_v7
EXIT_CODE=$?
