...
# Usage: sbatch submit_10_phaseD_cnn_lstm_v7.sh

#SBATCH --job-name=phaseD_cnn_lstm_v7
#SBATCH --output=logs/phaseD_cnn_lstm_v7.%j.out
#SBATCH --error=logs/phaseD_cnn_lstm_v7.%j.err
