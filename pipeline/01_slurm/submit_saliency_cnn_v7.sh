#!/usr/bin/env bash
#SBATCH --job-name=saliency_cnn_v7
#SBATCH --output=logs/saliency_cnn_v7.%j.out
#SBATCH --error=logs/saliency_cnn_v7.%j.err
...
echo "Running saliency_cnn against V7 | Job ${SLURM_JOB_ID} | $(date)"
cd ${PROJECT_DIR}
