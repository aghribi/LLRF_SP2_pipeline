#!/usr/bin/env bash
#SBATCH --job-name=09b_subclass_v7
#SBATCH --output=logs/09b_subclass_v7.%j.out
#SBATCH --error=logs/09b_subclass_v7.%j.err
...
SCRIPT="${PROJECT_DIR}/pipeline/00_scripts/prepare_09b_subclass_discovery.py"
