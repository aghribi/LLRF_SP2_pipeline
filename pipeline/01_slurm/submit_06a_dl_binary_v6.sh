#!/bin/bash
#SBATCH --job-name=06a_dl_binary_v6
#SBATCH --partition=gpu_v100
#SBATCH --gres=gpu:v100:1
#SBATCH --time=02:00:00
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/06a_dl_binary_v6_%j.out
#SBATCH --error=logs/06a_dl_binary_v6_%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=adnan.ghribi@ganil.fr

# ============================================================================
# Step 06a: Deep Learning Binary Classification
# Trains DNN and CNN models for LLRF fault/normal classification
# ============================================================================

echo "=========================================================================="
echo "STEP 06a: DEEP LEARNING BINARY CLASSIFICATION"
echo "=========================================================================="
echo "Job ID: $SLURM_JOB_ID (V6 dataset)"
...
SCRIPT_PATH="pipeline/00_scripts/prepare_06a_dl_binary.py"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "Status: SUCCESS"
    echo "Output: /sps/m4cast/_spiral2_data/_llrf_data/cooked_data/step_06a_dl_binary/"
else
    echo "Status: FAILED"
fi
