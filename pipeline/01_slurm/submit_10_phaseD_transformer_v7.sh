...
# Usage: sbatch submit_10_phaseD_transformer_v7.sh

#SBATCH --job-name=phaseD_transformer_v7
#SBATCH --output=logs/phaseD_transformer_v7.%j.out
#SBATCH --error=logs/phaseD_transformer_v7.%j.err
