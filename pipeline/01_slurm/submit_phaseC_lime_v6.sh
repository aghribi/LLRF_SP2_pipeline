#!/usr/bin/env bash
#SBATCH --job-name=phaseC_lime_v6
#SBATCH --output=logs/phaseC_lime_v6.%j.out
#SBATCH --error=logs/phaseC_lime_v6.%j.err
...
echo "Running phaseC_lime against V6 | Job ${SLURM_JOB_ID} | $(date)"
cd ${PROJECT_DIR}
