#!/usr/bin/env bash
#SBATCH --job-name=enhanced_shap_v7
#SBATCH --output=logs/enhanced_shap_v7.%j.out
#SBATCH --error=logs/enhanced_shap_v7.%j.err
...
SCRIPT="${PROJECT_DIR}/pipeline/00_scripts/prepare_10_enhanced_shap_analysis.py"
