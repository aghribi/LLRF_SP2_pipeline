#!/usr/bin/env bash
# SLURM submit script for Phase C (Label Powerset), against V7 dataset
# Usage: sbatch submit_09_phaseC_lp_v7.sh

#SBATCH --job-name=phaseC_lp_v7
#SBATCH --output=logs/phaseC_lp_v7.%j.out
#SBATCH --error=logs/phaseC_lp_v7.%j.err
