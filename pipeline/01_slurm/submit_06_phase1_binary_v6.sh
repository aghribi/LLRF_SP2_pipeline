#!/bin/bash
#SBATCH --job-name=step_06_v6
#SBATCH --output=logs/step_06_v6_%j.out
#SBATCH --error=logs/step_06_v6_%j.err
#SBATCH --time=2:00:00
...
echo "STEP 06: Phase 1 - Binary Classification | Job ${SLURM_JOB_ID} | $(date)"
...
${PYTHON_ENV} pipeline/00_scripts/prepare_06_phase1_binary.py \
    --input ${COOKED_DATA} \
    --output ${COOKED_DATA}/step_06_phase1_v6
EXIT_CODE=$?
