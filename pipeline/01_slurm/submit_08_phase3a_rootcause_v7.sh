#!/bin/bash
#SBATCH --job-name=step_08_v7
#SBATCH --output=logs/step_08_v7_%j.out
#SBATCH --error=logs/step_08_v7_%j.err
#SBATCH --time=2:00:00
...
echo "STEP 08: Phase 3A - Root Cause | Job ${SLURM_JOB_ID} | $(date)"
...
${PYTHON_ENV} pipeline/00_scripts/prepare_08_phase3a_rootcause.py \
    --input ${COOKED_DATA} \
    --output ${COOKED_DATA}/step_08_phase3a_v7
EXIT_CODE=$?
