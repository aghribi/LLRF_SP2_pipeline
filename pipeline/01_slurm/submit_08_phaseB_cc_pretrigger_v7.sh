#!/usr/bin/env bash
# SLURM submit script for Phase B (Classifier Chains), pre-trigger-only, V7 dataset
# Usage: sbatch submit_08_phaseB_cc_pretrigger_v7.sh

#SBATCH --job-name=phaseB_cc_pretrigger_v7
#SBATCH --output=logs/phaseB_cc_pretrigger_v7.%j.out
#SBATCH --error=logs/phaseB_cc_pretrigger_v7.%j.err
