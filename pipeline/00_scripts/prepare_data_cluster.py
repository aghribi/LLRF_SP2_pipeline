#!/usr/bin/env python3
"""
LLRF Anomaly Detection - Data Preparation for Cluster (MEMORY-OPTIMIZED V2)
================================================================================
...
def process_single_file_with_timeout(file_path, file_timeout=30, store_signals=False):
    ...
    try:
        ...
        # Apply quality filters (including RF power checks)
        if not passes_quality_filters(metadata, signals):
            return None
...
class LLRFDataPreparation:
    ...
    def save_results(self, batch_dir_or_results):
        ...
        # Free fault_labels immediately (now stored in y_binary/y_multilabel)
        del fault_labels
        gc.collect()
