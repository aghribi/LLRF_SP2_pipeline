...
# 2026-09-10: the trained-BR output directory picked up a version suffix
# starting with V7 (step_07_phaseA_v7_br) -- V6's is still the older
# unsuffixed step_07_phaseA_br, kept as-is here rather than assuming
# step_07_phaseA_v6_br (which also exists on disk but may not be the same run
# the rest of the V6 pipeline/manifests were built against) is equivalent.
